export const BUSINESS = {
  ...
  phone: '+1 (949) 305-3545',
  phoneRaw: '+19493053545',
  phoneDisplay: '(949) 305-3545',
...
export const SERVICES: ServiceInfo[] = [
  {
    ...
    metaDescription: 'Trusted residential electrician in Mission Viejo, CA. Wiring, lighting, panel upgrades, outlets & more. Licensed, bonded, insured. Call (949) 305-3545.',
    ...
    faqs: [
      { question: 'Do you offer free estimates for residential electrical work?', answer: 'Yes, we provide free estimates on most residential projects. Call (949) 305-3545 to schedule a visit from one of our Mission Viejo electricians.' },
  ...
  },
  {
    ...
    metaDescription: 'Reliable commercial electrician in Mission Viejo, CA. Tenant improvements, lighting, panel upgrades & emergency repair. Call (949) 305-3545.',
    ...
    faqs: [
      { question: 'Can you work after business hours to avoid downtime?', answer: 'Yes. We offer flexible scheduling including evenings and weekend appointments for commercial clients in Mission Viejo. Call (949) 305-3545 to arrange a time that works for your business.' },
  ...
  },
  {
    ...
    metaDescription: 'Fast electrical repair in Mission Viejo, CA. Flickering lights, tripping breakers, dead outlets & more. Licensed electricians. Call (949) 305-3545.',
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'Many electrical repairs in Mission Viejo can be completed the same day you call. We keep our service vehicles fully stocked with common parts so we can resolve most issues in a single visit. Call (949) 305-3545 and we\'ll dispatch an electrician to your door.',
      },
    ],
    faqs: [
      { question: 'How quickly can you respond to a repair call?', answer: 'We offer same-day service for most electrical repairs in Mission Viejo. Call (949) 305-3545 and we\'ll send an electrician as quickly as possible.' },
  ...
  },
  {
    ...
    metaDescription: '24/7 emergency electrician in Mission Viejo, CA. Power outages, sparking, burning smell — call (949) 305-3545 for fast emergency electrical service.',
    h1: 'Emergency Electrician in Mission Viejo, CA',
    summary: 'Electrical emergency in Mission Viejo? We respond fast — sparking, burning smells, power outages, and more. Call (949) 305-3545.',
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'If you smell burning or see sparks, turn off power at the main breaker if you can do so safely. Do not touch any affected outlets or switches. Evacuate the area if the smell is strong. Then call (949) 305-3545 and we\'ll guide you through next steps while an electrician is on the way.',
      },
    ],
    faqs: [
      { question: 'Do you offer 24/7 emergency electrical service?', answer: 'Yes. Emergency electrical services are available in Mission Viejo and surrounding areas. Call (949) 305-3545 any time, day or night.' },
      ...
      { question: 'How fast can an emergency electrician get to my Mission Viejo home?', answer: 'Because we are based in Mission Viejo, response times are typically very fast. We\'ll give you an estimated arrival time when you call (949) 305-3545.' },
    ],
  },
  {
    slug: 'panel-upgrade',
    ...
    metaDescription: 'Electrical panel upgrade in Mission Viejo, CA. Replace outdated 100A panels, add capacity for EV chargers & additions. Call (949) 305-3545.',
    ...
    faqs: [
      ...
      { question: 'How much does a panel upgrade cost?', answer: 'Costs vary based on amperage and whether your meter base or service entrance also needs upgrading. Call (949) 305-3545 for a free estimate tailored to your home.' },
    ],
  },
  {
    ...
    metaDescription: 'Expert EV charger installation in Mission Viejo, CA. Tesla, ChargePoint, JuiceBox & more. Level 2 home charging stations. Call (949) 305-3545.',
    ...
    faqs: [
      { question: 'How much does EV charger installation cost in Mission Viejo?', answer: 'Cost depends on your panel capacity, the distance from the panel to the charger location, and whether a panel upgrade is needed. Call (949) 305-3545 for a free estimate.' },
  ...
  },
  {
    ...
    metaDescription: 'Professional lighting installation in Mission Viejo, CA. Recessed lighting, LED retrofit, outdoor & landscape lighting. Call (949) 305-3545.',
  ...
  },
  {
    ...
    metaDescription: 'Outlet and switch repair in Mission Viejo, CA. Dead outlets, GFCI repair, dimmer installation & more. Licensed electricians. Call (949) 305-3545.',
    ...
    faqs: [
      ...
      { question: 'Can you add an outlet where there isn\'t one?', answer: 'Yes. We install new outlets in any room, including dedicated circuits for appliances, home offices, and EV chargers. Call (949) 305-3545 to schedule.' },
  ...
  },
  {
    ...
    metaDescription: 'Ceiling fan installation in Mission Viejo, CA. Indoor, outdoor, dual-fan setups & fan/light combos. Licensed electricians. Call (949) 305-3545.',
    ...
    faqs: [
      ...
      { question: 'How long does ceiling fan installation take?', answer: 'Most ceiling fan installations in Mission Viejo take 1 to 2 hours, including box replacement and wiring. We\'ll give you a time estimate when you call (949) 305-3545.' },
    ],
  },
  {
    ...
    metaDescription: 'Professional electrical inspection in Mission Viejo, CA. Home sale, insurance, safety inspections. Licensed electricians. Call (949) 305-3545.',
    ...
    faqs: [
      { question: 'How much does an electrical inspection cost?', answer: 'Inspection costs vary based on the size and age of your home. Call (949) 305-3545 for a quote. If you proceed with recommended repairs, the inspection fee is often credited toward the work.' },
...
export const HOME_FAQS = [
  ...
  { question: 'Do you offer free estimates?', answer: 'Yes, we provide free estimates on most residential and commercial electrical projects. Call (949) 305-3545 to schedule a visit from one of our electricians.' },
  { question: 'Do you provide emergency electrical service?', answer: 'Yes. Emergency electrical services are available for Mission Viejo and surrounding areas. Call (949) 305-3545 any time, day or night.' },
...
export const GENERAL_FAQS = [
  { question: 'Do you offer free estimates?', answer: 'Yes, we provide free estimates on most electrical projects. Call (949) 305-3545 to schedule a visit from one of our licensed electricians.' },
  ...
  { question: 'Do you provide emergency service?', answer: 'Yes. Emergency electrical services are available. Call (949) 305-3545 any time, day or night.' },
];
